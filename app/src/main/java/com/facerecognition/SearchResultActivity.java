...
public class SearchResultActivity extends AppCompatActivity {
    ...
    private int[] confidences=new int[BITMAP_LENGTH];
    private String[] results=new String[BITMAP_LENGTH];
    ...
    private void init(){
        ...
        final String resultUrl=intent.getStringExtra("resultUrl");
...
//                }
                ...
                try {
                    ...
                    for(int i=0;i<candidates.length();i++){
                        ...
                        results[i]=person.getString("person_id");
                        confidences[i]=person.getInt("confidence");
                    }
                } catch (IOException e) {
                    e.printStackTrace();
                ...
                for(int i=0;i<BITMAP_LENGTH;i++){
                    bitmaps[i]=ImageUtil.getURLBitMap("http://face--recognition.oss-cn-shanghai.aliyuncs.com/"+results[i]);
                }
...
//                bitmaps[4]= ImageUtil.getURLBitMap("http://face--recognition.oss-cn-shanghai.aliyuncs.com/dcy2.jpg");
        ...
        recyclerViewAdapter=new RecyclerViewAdapter(bitmaps,confidences);
